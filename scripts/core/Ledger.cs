...
public class Ledger
{
    /// <summary>本月各类目金额（文，收入为正、支出为负）。</summary>
    public Dictionary<string, long> Current = new();

    /// <summary>上月各类目金额（文）。</summary>
    public Dictionary<string, long> Previous = new();

    /// <summary>记一笔流水（amount 收入为正、支出为负，文）。</summary>
